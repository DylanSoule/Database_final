...
(8,'The diamond','Huge face on the front of longs peak','trad,alpine'),
(3,'North Table','Climbing at North table Mountain by Golden','sport');
...
("Blood Money",7,'bouldering', 'V12', "Large squeezy shouldery heel hooky",'Daniel Woods',3.9),
("Top notch",7,'bouldering','V13',"Big moves on crimps",'Daniel Woods',3.0),
("Great white",9,'bouldering','V6',"Really cool arete boulder, looks like a great white fin",NULL,4.2),
("Ariana",11,'alpine','5.12a',"6 pitch ascent",NULL,4.0),
("La Marie-Rose",10,'bouldering','6a','Probably the most famous font boulder. Crux involves a long reach to a small hold before topping out.','Rene Ferlet',4.5),
("Rainbow Rocket",10,'bouldering','8a','Big jump step up bloc',NULL,3.5),
("Culp-Bossier",6,'trad','5.8','8 pitch climb up hallet peak from emerald lake side',NULL,4.0),
("Freshly Squeezed",7,'bouldering','V12','Start low on areta and small left crimp and climb out on incuts.','Dave Graham',4.3),
("Makaila",7,"bouldering",'V7',"Hard move to a crimp followed by easier climbing of the clear rails.",NULL,3.1),
("Tubesnake boogie",9,'bouldering','V9',"One of the most fun in the area, maneuver around the 'Tubesnake' formation followed by a long topout",NULL, 4.7),
("Bullet The Brown Cloud",12,'sport','5.11c','Start with a funky move and work the face',NULL,3.0);
